...
- (void)viewDidLoad {
    ...
    [ONHeadRequestOperation addHeadRequestOperationWithURL:[NSURL URLWithString:@"http://www.apple.com/robots.txt"] withHeadRequestCompletionHandler:^(NSDictionary *dictionary, NSError *error) {
        if (error != nil) {
